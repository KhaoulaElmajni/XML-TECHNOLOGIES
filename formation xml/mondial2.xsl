...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="continent"></xsl:param>
    <xsl:template match="/">
        <html>
            <head>
                ...
                <div class="container">
                    ...
                    <table border="2" cellpadding="4" class="table table-bordered" width="100%">
                           ...
                           <xsl:call-template name="country" >
                               <xsl:with-param name="countries" select="*/country[encompassed/@continent=$continent]"></xsl:with-param>
                           </xsl:call-template>
    ...
    <xsl:template name="country">
        <xsl:param name="countries"></xsl:param>
                    ...
                    <tr class="{$cls}" align="center">
                        ...
                        <td>
                            <xsl:value-of select="$countries/name"/> 
                            
                        </td>
                        <td>
                            <xsl:value-of select="$countries//city[@id=$capital]/name"/>  
                            
                        </td>
                        
                        <td align="right">
                            <span class="pop">
                                <xsl:value-of select="format-number($countries/population[last()],'# ##0,##','pop')"/>
                            </span>
                        </td>
                        <td>
                            <select>
